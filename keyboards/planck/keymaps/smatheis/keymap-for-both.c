...
const uint16_t PROGMEM C_AE[] =      {KC_ESC,   CC_M_CTL,   COMBO_END};
const uint16_t PROGMEM C_OE[] =      {KC_ESC,   CC_U_ALT,   COMBO_END};
const uint16_t PROGMEM C_UE[] =      {KC_ESC,   CC_F_SFT,   COMBO_END};
const uint16_t PROGMEM C_SS[] =      {KC_ESC,   KC_V,       COMBO_END};
